...
const ghosteditMock = {
  ...
  getBonsaiStatus: vi.fn().mockResolvedValue({ models: [], server: { running: false, port: null, healthy: false, modelSize: null } }),
  downloadBonsaiModel: vi.fn().mockResolvedValue({ success: true }),
  onDownloadBonsaiProgress: vi.fn().mockReturnValue(noopRemover),
  onDownloadBonsaiError: vi.fn().mockReturnValue(noopRemover),
